...
function my_site_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'my_site_custom_background_args', array(
...
function my_site_scripts() {
	wp_enqueue_style( 'my_site-style', get_stylesheet_uri() );

	wp_enqueue_script( 'my_site-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'my_site-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
